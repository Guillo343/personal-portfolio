...
export const projectsData = [
    ...
    },
    {
      ...
      description: "A mobile-first travel application that helps users discover attractions, restaurants, and accommodations based on geolocation with integrated reviews and ratings.",
      image: "/images/projects/travel-companion.jpg",
      tags: ["React", "Material UI", "Google Maps API", "RapidAPI"],
      category: "Web App",
      sourceCode: "https://github.com/yourusername/travel-companion",
      liveDemo: "https://travel-companion-app.netlify.app/",
      featured: true
    },
    {
      id: 3,
